 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_MICROSTEPS     GLOBAL_MICROSEPS        // 0..256
    ...
    #define Y_MICROSTEPS     GLOBAL_MICROSEPS
    ...
    #define Z_MICROSTEPS     GLOBAL_MICROSEPS
    ...
    #define E0_MICROSTEPS    GLOBAL_MICROSEPS
   ...
   */
  #define TMC_PORT1_RX 12 // Must be interrupt capable
  #define TMC_PORT1_TX 11
